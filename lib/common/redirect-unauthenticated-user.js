...
//@TODO: Bring in urlFactory from Moonshot
const weedmapsUrl = 'https://weedmaps.com';
const siteUrl = 'https://weedmaps.com';
...
export function redirectToLoginPage(returnPath = null, props) {
  ...
  redirectTo(props, `${weedmapsUrl}/login?return_url=${returnUrl}`, true);
}
