...
function setup() {
  ...
  const mockFetchClient = {
    ...
    fetch: jest
      .fn()
      .mockReturnValue(Promise.resolve({ data: mockWmxUser }))
      .mockReturnValueOnce(Promise.resolve({ data: mockWmxUser }))
      .mockReturnValueOnce(Promise.resolve({ data: mockOrg })),
  };
...
describe('Auth Store', () => {
  ...
  it('should be able to fetchBrand', async () => {
    const mockFetchClient = {
      fetch: jest.fn().mockReturnValue({ data: mockBrand }),
    };
  ...
  it('should be able to updateBrand', async () => {
    ...
    const brand = {
      ...
      name: 'test',
      id: 'd60ca06a-89db-4584-99a8-1f9b9f427e42',
      licenses: [{ licenseType: '123', id: '123', number: '1234' }],
      phoneNumber: '123',
      email: '123@weedmaps.com',
      ...
      '/brands/d60ca06a-89db-4584-99a8-1f9b9f427e42',
      {
        data: {
          attributes: {
            ...
            minimum_purchase_price: 10,
            name: 'test',
            licenses: [{ id: '123', license_type: '123', number: '1234' }],
            phone_number: '123',
            email: '123@weedmaps.com',
            address: '41 discovery',
            contact_name: 'Andrew',
    ...
    expect(mockFetchClient.put).toHaveBeenCalledWith('/organizations/1234', {
      data: {
        attributes: {
          ...
          id: '1234',
          licenses: [{ license_type: '123', id: '123', number: '1234' }],
        },
        id: '1234',
        type: 'address',
      },
