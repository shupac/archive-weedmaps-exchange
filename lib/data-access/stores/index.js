...
import CatalogSearchStore from './catalog-search';
...
console.log('URLS ', apiGatewayUrl, apiRootPath);
...
const RootStore = types.model({
  ...
  catalogSearchStore: CatalogSearchStore,
});
  ...
  return RootStore.create(
    {
      ...
      catalogSearchStore: CatalogSearchStore.create(),
    },
