...
describe('zone', () => {
  ...
  it('can add the cId if not specified in snapshot', () => {
    zone = Zone.create({
      cId: '',
      id: '123',
      name: 'Some Zone',
  ...
  describe('when creating on the client', () => {
    describe('when it succeeds', () => {
      ...
      it('will create it on the server and update the client version', async done => {
        ...
        expect(clientZone.lastError).toEqual(null);
        done();
      });
    });
    ...
    describe('when it fails', () => {
      ...
      it('will set the model as being out of sync', async done => {
        await clientZone.create();
        expect(sdkClient.post).toHaveBeenCalledWith('/seller/zones', {
          data: {
            attributes: { color: '#333', name: 'Some Zone', region_ids: [3] },
  ...
  describe('when updating on the client', () => {
    describe('when it succeeds', () => {
      ...
      it('will update it on the server and update the client version', async done => {
  ...
  describe('when deleting on the client', () => {
    describe('and it succeeds', () => {
      ...
      it('will delete on the server', async done => {
